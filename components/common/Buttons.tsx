...
export function PrimaryButton(props: Omit<ButtonProps, "className">) {
  return (
    <button
      className="flex h-fit w-fit items-center justify-center rounded-lg bg-blue-600 px-4 py-2 text-xl font-bold text-white hover:bg-blue-700 disabled:bg-blue-900"
      {...props}
    ></button>
  );
}
