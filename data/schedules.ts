...
const thursday = {
  ...
  ThirdPeriod: ["ゼミナール", "自主学習"] as const,
  FourthPeriod: ["英語コミュニケーション", "エキスパートプログラム(英語スピーチ&エッセイ)", "エキスパートプログラム(中国語検定3級対策)", "エキスパートプログラム(中国語スピーチ対策)", "自主学習"] as const,
  FifthPeriod: ["TAサポート教養数学", "エキスパートプログラム(英語スピーチ&エッセイ)", "エキスパートプログラム(中国語検定3級対策)", "エキスパートプログラム(中国語スピーチ対策)", "自主学習"] as const,
  SixthPeriod: ["コミュニティ活動", "自主学習"] as const,
} satisfies DayColumn;

const friday = {
  FirstPeriod: ["英検準2級対策(アーカイブ)", "プロジェクトNβ", "自主学習"] as const,
  SecondPeriod: ["英検準2級対策(アーカイブ)", "プロジェクトNβ", "自主学習"] as const,
