...
export default function About() {
  return (
    <div className="h-fit w-screen snap-y snap-mandatory overflow-y-scroll">
        ...
        <div className="flex h-full w-full items-center justify-center">
          <div className="mx-auto my-auto h-fit w-fit">
            ...
            <div className="mt-4 flex flex-row items-center justify-center">
              <div className="ml-48 mr-4 inline-block h-0 w-20 border-t-2 border-black align-middle"></div>
      ...
      <div className="h-screen w-screen snap-start snap-always">
        <div className="flex h-full w-full items-center justify-center">
          <div className="flex flex-row items-center justify-center gap-16 px-16">
            <div>
      ...
      <div className="flex h-screen w-screen snap-start snap-always items-center justify-center">
        <div className="flex flex-row items-center justify-center gap-16 px-16">
          <div>
            <h1 className="text-4xl font-bold">使用技術</h1>
            <p className="pb-4 pt-4 text-xl">
