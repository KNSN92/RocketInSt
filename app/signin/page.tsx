...
function GoogleSignInButton({ callbackUrl }: { callbackUrl: string }) {
  return (
    <SignInButton provider="google" options={{ callbackUrl: callbackUrl }}>
      <div className="shadow-md w-fit h-20 px-6 flex items-center justify-center rounded-full bg-gray-100 border-[#747775] border-2 text-[#1F1F1F]">
        ...
        <div className={`text-3xl ${RobotoMidiumFont.className}`}>Sign in with Google</div>
      </div>
    </SignInButton>
  )
}
