...
export default async function seed() {
    ...
    const afterschoolPeriodTemp: Omit<Prisma.PeriodCreateManyInput, "weekday"> = {
        ...
        beginTime: AfterSchoolPeriodTime.start.hours * 60 + AfterSchoolPeriodTime.start.minutes,
        endTime:   AfterSchoolPeriodTime.end.hours * 60 + AfterSchoolPeriodTime.end.minutes,
        tag: "Other",
    };
    await prisma.period.createMany({
        data : WeekDayArray.map((weekday) => ({
