...
function PaginationButton(
  ...
  const className = clsx(
    ...
    props.disabled
      ...
      : "bg-blue-500 border-blue-400 hover:bg-blue-400 hover:border-blue-300 dark:bg-transparent dark:border-blue-500 dark:text-blue-500 dark:hover:border-blue-700 dark:hover:text-blue-700",
  );
  if (props.disabled) {
